# social-media-publisher serverless API
The social-media-publisher project, created with [`aws-serverless-java-container`](https://github.com/awslabs/aws-serverless-java-container).
...
```bash
$ mvn archetype:generate -DartifactId=social-media-publisher -DarchetypeGroupId=com.amazonaws.serverless.archetypes -DarchetypeArtifactId=aws-serverless-springboot-archetype -DarchetypeVersion=1.4 -DgroupId=com.coderstower -Dversion=1.0-SNAPSHOT -Dinteractive=false
            ...
            "Outputs": [
                {
                    ...
                    "ExportName": "SocialMediaPublisherApi",
                    "OutputKey": "SocialMediaPublisherApi",
